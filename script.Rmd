---
title: "Additional Lecture Notes for Statistics for Biology"
...
```{r, out.width="70%", setup, include=FALSE}
...
```{r, out.width="70%", libraries.eval,echo = TRUE,results='hide', message=F, warning=F}
...
```{r, out.width="70%", mileage_aes_themes}
p = ggplot(data = mpg) + 
  geom_point(mapping = aes(x = displ, y = hwy), color = "blue") 
...
```{r, out.width="70%", echo = F, warning = F,message = FALSE}
