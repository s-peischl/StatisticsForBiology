...
### Exercise 19
Load the dataset chap08e1DayOfBirth.csv. Each row represents a single birth, and shows the day of the week of birth. Test the null hypothesis that birthdays are randomly distributed in the sense that each day occurs with a probability of $1/7$. Visualize your results and give an interpretation of the test results. Can you come a up with a potential explanation? 
