...
a) Compare the distribution of plate numbers to a normal distribution with the same mean and variance. Do this for each genotpye separately. Is it justified do assume a normal distribution? 

b) Use the function t.test for each genotype to obtain confidence intervals of the mean plate number for each genotype. Compare this with confidence intervals calculated by hand. Are the results different? If so, can you explain why? 
