...
If you like to learn more about the theoretical underpinnings of ggplot2 before you start, I???d recommend reading "The Layered Grammar of Graphics", http://vita.had.co.nz/papers/layered-grammar.pdf.
...
```
We could now compare how the disitrbution of genotpyes changes if we condition on more than 10 plates:
```{r}
...
```{r}
hist(permResult[permResult>diffMeans],breaks=seq(-40,40,by=1),col="darkred",main="")
hist(permResult[permResult<=diffMeans],breaks=seq(-40,40,by=1),add=T,col="red")
