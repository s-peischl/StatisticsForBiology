...
c) Estimate a linear regression model using the data. Inspect the output - is the slope of the model significantly different from 0?

d) Calculate a confidence interval for the slope of the regression line.

e) Plot the data and add a regression line and a confidence band for the regression line.
...
<!-- ```{r} -->
<!-- ggplot(data = lion) + -->
<!--   geom_point(mapping = aes(x = proportionBlack,y = ageInYears)) + -->
<!--   geom_smooth(mapping = aes(x = proportionBlack,y = ageInYears), method = "lm") -->
...
<!-- ypt.pred <- data.frame( predict(lionRegression,  -->
<!-- 	newdata = data.frame(proportionBlack = xpt),  -->
<!-- 	interval = "prediction") ) -->
