...
output:
  ...
  word_document:
    toc: yes
abstract: 'These notes provide a short introduction to R as well as the exercises
  for the pracitcal part of the course. The aim of these notes is to provide you with
  a tool to solve the exercises for each week and to learn some R along the way. '
---
