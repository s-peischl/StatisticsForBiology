...
## Week 7 (13.04.2021)
#### Exercise 16
Use the stickleback data set. Perform a t.test for each comparison of plate numbers between genotypes. Compare the outcome of the t.tests with the results from the confidence intervals. What do you find?
